...
(function () {
  ...
  var KZ = {
    ...
    art_h1:'Рефлексотомия: бұл қандай әдіс және неге көмектеседі',
    ...
    toc_2:'Аз инвазиялық және жансыздандыру',
    toc_3:'Жарықтың резорбция бағдарламасы',
    toc_4:'Өкше шпорасы',
    toc_5:'Буын аурулары',
    toc_6:'Неге рефлексотомияны таңдайды',
    toc_7:'Қабылдауға қалай жазылуға болады',

    s1_eye:'Артықшылықтары',
    s1_h2:'Рефлексотомияның негізгі артықшылықтары',
    s1_p:'Төменде - әдісті жиі таңдайтын төрт себеп: процедура қалай өтеді, жарықтың резорбция бағдарламасына не кіреді, өкше шпорасында неден үміт күтуге болады және буын ауруларында рефлексотомия не береді.',
    p1_h:'Тілік емес, тесік',
    ...
    s2_p1:'Рефлексотомия хирургиялық тіліксіз, кішкене тесік арқылы жүргізіледі. Әсер етер алдында жергілікті жансыздандыру қолданылады, сондықтан процедура әдетте жайлы өтеді. Сезім науқастың сезімталдығына және емделетін аймаққа қарай әртүрлі болуы мүмкін.',
    ...
    f4_h:'Ауруханаға жатқызусыз', f4_p:'қалпына келу қысқа',

    s3_eye:'Жарық',
    s3_h2:'Омыртқааралық жарықтың резорбция бағдарламасы',
    s3_p1:'Омыртқааралық жарығы бар науқастар үшін Reflex клиникасында жарықтың резорбциясының жеке бағдарламасы қарастырылған.',
    ...
    s3_note:'Нәтижені бағалау үшін дәрігер бақылау МРТ-сын ұсынуы мүмкін. Жарықтың кішірею жылдамдығы мен дәрежесі әркімде әртүрлі, сондықтан әр науқасқа толық сіңіп кетуге уәде беруге болмайды.',
    ...
    s6_eye:'Қысқаша',
    s6_h2:'Науқастар неге рефлексотомияны таңдайды',
    ...
    cta_note:'Қабылдауды клиниканың дәрігері жүргізеді. Диагностика тағайындау бойынша тексеруді алмастырмайды.',
  ...
  var META = {
    ...
    kz: {
      title:'Рефлексотомия: бұл қандай әдіс, қалай өтеді және неге көмектеседі - Reflex Clinic Алматы',
