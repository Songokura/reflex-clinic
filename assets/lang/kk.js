...
window.SITE_KK = {
  dict: {
    ...
    lp_gryzha:'Жарықты емдеу туралы толығырақ', lp_spina:'Арқа ауырсынуын емдеу туралы толығырақ',
    lp_shpora:'Өкше шпорасын емдеу туралы толығырақ',
    lp_gryzha_s:'Омыртқа жарығы', lp_spina_s:'Арқа ауырсынуы', lp_shpora_s:'Өкше шпорасы',
    sb_book:'Жазылу', sb_call:'Қоңырау шалу', q_call:'Қоңырау шалу',
    ask_wa:'Дәрігерден WhatsApp арқылы сұраңыз',
    ct_wa:'WhatsApp арқылы жазу',
    fm_or:'Форманы толтырғыңыз келмей ме?', fm_wa:'Дәрігерге WhatsApp арқылы жазыңыз',
  ...
  /* текст кнопки «Спросить в WhatsApp» на казахской версии */
  wa: 'Сәлеметсіз бе! Reflex Clinic сайтынан жазып отырмын - емдеу туралы айтып жіберіңізші.'
};
